...
class FornecedoresController(BaseController):

    """A Controller to access Endpoints in the capstone API."""

    def __init__(self, config, call_back=None):
        super(FornecedoresController, self).__init__(config, call_back)

    def criar_fornecedor(self,
                         body,
                         content_type):
        """Does a POST request to /provider.

        Endpoint destinado à criação de fornecedor diretamente na tabela
        provider (fornecedor).

        Args:
            body (CriarFornecedorRequest): TODO: type description here.
    ...
    def exibir_fornecedores(self):
        """Does a GET request to /provider.
    ...
    def alterar_fornecedor(self,
                           body,
                           content_type):
        """Does a PATCH request to /provider/2.

        Realiza alteração de nome do fornecedor, cnpj ou telefone selecionado
        por id, através de url params.

        Args:
            body (AlterarFornecedorRequest): TODO: type description here.
            content_type (string): TODO: type description here.
    ...
    def remover_fornecedor(self):
        """Does a DELETE request to /provider/4.
