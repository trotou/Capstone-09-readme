...
class ProdutosDasOrdensDeCompraController(BaseController):

    """A Controller to access Endpoints in the capstone API."""

    def __init__(self, config, call_back=None):
        super(ProdutosDasOrdensDeCompraController, self).__init__(config, call_back)

    def criar_produto_ordem_de_compra(self,
                                      body,
                                      content_type):
        """Does a POST request to /product_purchase_order.

        Cria a relação entre produtos e ordens de compra

        Args:
            body (CriarProdutoOrdemDeCompraRequest): TODO: type description
                here.
        ...
        # Prepare query URL
        _url_path = '/product_purchase_order'
    ...
    def exibir_produto_ordem_de_compra(self):
        """Does a GET request to /product_purchase_order.
    ...
    def alterar_produto_ordem_de_compra(self,
                                        body,
                                        content_type):
        """Does a PATCH request to /product_purchase_order/3.

        Altera dados dos produtos ordens de compra

        Args:
            body (AlterarProdutoOrdemDeCompraRequest): TODO: type description
                here.
            content_type (string): TODO: type description here.
        ...
        # Prepare query URL
        _url_path = '/product_purchase_order/3'
        _query_builder = self.config.get_base_uri()
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
    ...
    def remover_produto_ordem_de_compra(self):
        """Does a DELETE request to /product_purchase_order/3.
