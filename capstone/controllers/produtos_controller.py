...
class ProdutosController(BaseController):
    ...
    def __init__(self, config, call_back=None):
        super(ProdutosController, self).__init__(config, call_back)
    ...
    def criar_produto(self,
        ...
        Realiza a criação de um produto diretamente na tabela products
        (produtos).

        Args:
            body (CriarProdutoRequest): TODO: type description here.
    ...
    def alterar_produto(self,
                        body,
                        content_type):
        """Does a PATCH request to /product/2.

        Realiza alteração de nome, descrição, preço e quantidade em stock
        selecionado por id, através de url params.

        Args:
            body (AlterarProdutoRequest): TODO: type description here.
            content_type (string): TODO: type description here.
    ...
    def remover_produto(self):
        """Does a DELETE request to /product/7.
